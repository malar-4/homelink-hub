      ...
      <div className="hidden lg:flex flex-1 bg-accent relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-12 text-center">
          ...
          >
            ...
            <p className="text-accent-foreground/80 max-w-md mb-8">
              Sign in to continue your property search or manage your listings.
            </p>
            ...
            <div className="relative h-48 w-full max-w-sm mx-auto">
              <motion.div
                ...
                className="absolute left-0 top-0 w-32 h-24 bg-accent-foreground/10 backdrop-blur-sm rounded-xl p-3"
              >
              ...
              <motion.div
                ...
                className="absolute right-0 top-8 w-32 h-24 bg-accent-foreground/10 backdrop-blur-sm rounded-xl p-3"
              >
                <div className="w-full h-2 bg-accent-foreground/20 rounded mb-2" />
              ...
              <motion.div
                ...
                className="absolute left-1/4 bottom-0 w-32 h-24 bg-accent-foreground/10 backdrop-blur-sm rounded-xl p-3"
              >
                <div className="w-full h-2 bg-accent-foreground/20 rounded mb-2" />
