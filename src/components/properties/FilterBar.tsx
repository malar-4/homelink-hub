    ...
    <div className="bg-card rounded-2xl shadow-lg border border-border p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 relative">
          ...
          >
            <SelectTrigger className="pl-10 h-12 rounded-xl border-border">
        ...
        <div className="w-full lg:w-40">
          <Select
            value={filters.bhk}
            onValueChange={(value) => setFilters({ ...filters, bhk: value })}
          >
        ...
        <Sheet open={isAdvancedOpen} onOpenChange={setIsAdvancedOpen}>
          <SheetTrigger asChild>
            <Button
              variant="outline"
              className="h-12 rounded-xl border-border relative"
            >
          ...
          <SheetContent className="w-full sm:max-w-md overflow-y-auto">
            ...
            <div className="mt-6 space-y-6">
              ...
              <Button
                ...
                onClick={() => {
                  onFilterChange?.({ ...filters, priceMin: priceRange[0], priceMax: priceRange[1] });
